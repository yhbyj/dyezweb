...
if __name__ == '__main__':
    ...
    user = User.objects.create_superuser('admin', 'admin@dyez.com', 'admin')
    print('create some faked users joined within the past year')
    myfaker = Faker('zh_CN')
    ...
    for _ in range(25):
        ...
        user = User.objects.create_user(username=myfaker.user_name(),
                                 email=myfaker.email(),
                                 password='123',
                                 is_staff=False,
